...
head_url = 'https://weibo.com/ajax/feed/hottimeline?refresh=2&group_id=102803&containerid=102803&extparam=discover%7Cnew_feed&max_id='
tail_url = '&count=10'


def base_url(i):
    return head_url + str(i) + tail_url
    ...
    if _json is not None:
        ...
        for i in items:
            ...
            if isLongText:
                ...
                _text = pq(i.get('text_raw')).text().replace(" ", "").replace("\n", "")
